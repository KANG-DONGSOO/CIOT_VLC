...
DECODE_OOK_SECOND:
	...
	QBLT	RCV_ER_PKT, r14, 1					// * IF packet_state is after packet length, if erroneous value (HIGH-HIGH or LOW-LOW) is received, just add random number to be fixed by RS
	MOV		r8, 1								// * cnt_symbol <- 1
	MOV		r9, 0								// * cnt_premable <- 0
	MOV 		r10, r7								// * prev_symbol  <- current_value
...
PROCESS_LENGTH:
	...
	QBNE		LENGTH_INVALID, r16, PAYLOAD_LEN
