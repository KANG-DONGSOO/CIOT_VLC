...
START:
	...
	LBBO    r8, r1, 4, 4     // The Delay for clock
	LBBO	r9, r1, 8, 4	 // Number of sample limit
	MOV r10, 4 //Current index for sample storing

	MOV	r3, 0x00000000	 // clear r3 to receive the response from the MCP3XXX
	MOV r12, 0x00010000 //Shared memory address to send to OOK PRU
...
STORE_DATA:                      // store the sample value in memory
	...
	SBBO	r3.w0, r12, r10, 2	 // store the value r3 in memory
	SBBO	r10, r12, 0, 4
	ADD	r10, r10, 2	 // shifting by 2 bytes - 2 bytes per sample
	QBEQ	RESET, r9, 0       // have taken the full set of samples
